...
class Config(object):
    ...
    # NOTE FOR REVIEWER:
    # The real CLIENT_ID and CLIENT_SECRET are intentionally NOT committed to this repo.
    # They are supplied in the runtime as Azure App Service Application Settings
    # (Azure Portal -> App Service -> Settings -> Environment variables), which the
    # platform can use as environment variables. This keeps the credentials out of
    # git and azuredevops pipelines.
    # The 'ENTER_..._HERE' are only fallbacks for the case where no env variables is set.
    # The same is already used above for the Blob Storage and SQL credentials.